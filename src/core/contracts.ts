...
// A model-visible batch is intentionally smaller than the direct library/CLI
// batch. Eight exact assets cover ordinary comparison work without turning one
// Agent round trip into a large SVG context dump.
export const MAX_MCP_BATCH_SIZE = 8;
export const MAX_SVG_BYTES = 64 * 1024;
// The pinned corpus currently fits a full 20-icon batch below 80 KiB. Keep
...
// than being replayed into every Agent turn.
export const MAX_MCP_TOOL_CATALOG_BYTES = 10 * 1024;
export const MAX_MCP_MODEL_RESPONSE_BYTES = 80 * 1024;
