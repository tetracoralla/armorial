...
const english = {
  ...
  copyIconLink: "Copy link",
  iconLinkCopied: "Icon link copied",
  invalidIconLink: "This icon link is invalid. You can still search and choose an icon.",
  changedIconLink: "This icon differs from the shared version. Review its current appearance before using it.",
  missingIconLink: "This shared icon is not in the current collection. You can still search and choose an icon.",
  dismiss: "Dismiss",
  agentHeading: "Agent",
...
const simplifiedChinese: Record<MessageKey, string> = {
  ...
  copyIconLink: "复制链接",
  iconLinkCopied: "图标链接已复制",
  invalidIconLink: "图标链接无效，你仍然可以搜索并选择图标。",
  changedIconLink: "图标与分享时的版本不同，使用前请确认当前外观。",
  missingIconLink: "分享的图标不在当前集合中，你仍然可以搜索并选择图标。",
  dismiss: "关闭",
  agentHeading: "Agent",
